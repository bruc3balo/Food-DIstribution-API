...
public class FoodDistributionApplication {
    ...
    CommandLineRunner run() {
        return args -> {
            ...
            NewUserForm certifiedF = new NewUserForm("certified", "certified", "certified@authority.com", "certified", "+254700000003", "4", "help", AppRolesEnum.ROLE_CERTIFIED_AUTHORITY.name());
