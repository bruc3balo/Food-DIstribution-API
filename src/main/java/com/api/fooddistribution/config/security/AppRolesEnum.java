...
public enum AppRolesEnum {
    ...
    ROLE_SELLER(Sets.newHashSet(USER_UPDATE, USER_READ, USER_DELETE, USER_WRITE,PRODUCT_READ,PRODUCT_WRITE,PURCHASE_READ,PURCHASE_WRITE,PURCHASE_UPDATE,PRODUCT_CATEGORY_READ,DISTRIBUTION_READ,DISTRIBUTION_WRITE));
